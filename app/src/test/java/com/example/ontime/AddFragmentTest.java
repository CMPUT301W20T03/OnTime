...
class AddFragmentTest {
    ...
    void testOnCreateView() {
        View result = addFragment.onCreateView(null, null, null);
    ...
    void testNewInstance() {
        AddFragment result = AddFragment.newInstance(new CurrentRequests("name", "phone", "email", "srcLocationText", "destinationText", "amount", "status"));
    ...
    void testOnCreateDialog() {
        ...
        when(current_request.getSrcCoordinate()).thenReturn("getSrcCoordinateResponse");
        when(current_request.getDstCoordinate()).thenReturn("getDstCoordinateResponse");
