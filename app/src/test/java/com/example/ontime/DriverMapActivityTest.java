...
class DriverMapActivityTest {
    ...
    void testOnOkPressed() {
        driverMapActivity.onOkPressed(new RequestList(null, new ArrayList<CurrentRequests>(Arrays.asList(new CurrentRequests("name", "phone", "email", "srcLocationText", "destinationText", "amount")))));
    }
}
